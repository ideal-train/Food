...
public class TipsDialog {
    ...
    public TipsDialog(Builder builder) {
        ...
        img_bid = (ImageView) mDialogView.findViewById(R.id.img_bid);
...
//                builder.getWidth());
    ...
    private void initDialog(Builder builder) {
        ...
        if (builder.isBid()) {
            ...
            img_bid.setVisibility(View.GONE);
        ...
        mLeftBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mBuilder.getOnclickListener() != null) {
                    ...
                    mBuilder.getOnclickListener().clickLeftButton(TipsDialog.this, mLeftBtn);
                }
            }
        });
        mRightBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mBuilder.getOnclickListener() != null) {
                    ...
                    mBuilder.getOnclickListener().clickRightButton(TipsDialog.this,
                            mRightBtn);
                }
        ...
        mSingleBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mBuilder.getSingleListener() != null) {
                    ...
                    mBuilder.getSingleListener().clickJustOneleButton(TipsDialog.this,
                            mSingleBtn);
                }
            }
        });
    ...
    public static class Builder {
        ...
        private SelectDialogInterface.OnLeftAndRightClickListener<TipsDialog> onclickListener;
        private SelectDialogInterface.OnSingleClickListener<TipsDialog> singleListener;
        ...
        public Builder setBid(boolean singBid) {
            isBid = singBid;
            return this;
        }
        ...
        public SelectDialogInterface.OnLeftAndRightClickListener<TipsDialog> getOnclickListener() {
            return onclickListener;
        }

        public Builder setOnclickListener(SelectDialogInterface
                                                  .OnLeftAndRightClickListener<TipsDialog>
                                                  onclickListener) {
            this.onclickListener = onclickListener;
            return this;
        }

        public SelectDialogInterface.OnSingleClickListener<TipsDialog> getSingleListener() {
            return singleListener;
        }

        public Builder setSingleListener(SelectDialogInterface.OnSingleClickListener<TipsDialog>
                                                 singleListener) {
