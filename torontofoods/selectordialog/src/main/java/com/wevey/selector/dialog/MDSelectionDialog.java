...
//        lp.width =WindowManager.LayoutParams.MATCH_PARENT;
    ...
    public static class Builder {
        ...
        //item属性
        private SelectDialogInterface.OnItemClickListener<MDSelectionDialog> onItemListener;
        ...
        public SelectDialogInterface.OnItemClickListener<MDSelectionDialog> getOnItemListener() {
            return onItemListener;
        }

        public Builder setOnItemListener(SelectDialogInterface.OnItemClickListener<MDSelectionDialog> onItemListener) {
