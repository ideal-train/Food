...
//        lineView.setBackgroundColor(mBuilder.getLineColor());
        mLeftBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mBuilder.getListener() != null) {
                    ...
                    mBuilder.getListener().clickLeftButton(EditDialog.this, mLeftBtn);
                }
        ...
        mRightBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mBuilder.getListener() != null) {
                    ...
                    mBuilder.getListener().clickRightButton(EditDialog.this, mRightBtn);
                }
            }
        });
    ...
    public static class Builder {
        ...
        private SelectDialogInterface.OnLeftAndRightClickListener<EditDialog> listener;
        ...
        public SelectDialogInterface.OnLeftAndRightClickListener<EditDialog> getListener() {
            return listener;
        }

        public Builder setOnclickListener(SelectDialogInterface.OnLeftAndRightClickListener<EditDialog> listener) {
